...
public class UnitRepresentation : MonoBehaviour
{
    ...
    public void DisplayInfo(UnitInfoData info)
    {
        if (info == null)
        {
            return;
    ...
    public void DisplayUnit(string unitName)
    {
        DisplayInfo(RunMetagameDisplayInfoFactory.BuildUnitInfo(unitName, DataMapper.Instance));
    }
    ...
    void BindSkillSlots()
    {
        ...
        for (int i = 0; i < SkillIcons.Count; i++)
        {
            ...
            UnitRepresentationSkillSlot slot = SkillIcons[i].GetComponent<UnitRepresentationSkillSlot>();
            if (slot == null)
            {
                slot = SkillIcons[i].gameObject.AddComponent<UnitRepresentationSkillSlot>();
            }
