...
- Historical PRD019 route-node prefab generation has been removed. Do not recreate builder scripts or regenerate `Assets/Resources/UI/PRD_19/021_RunMap/Prefabs/PRD_19_021_RunMap_RouteNode_Polished.prefab` without current path-specific user permission.
...
- Let Unity recompile/import scripts. Do not run or recreate PRD019 prefab builders; inspect the existing polished prefab only unless the current task grants path-specific permission to edit it.
