...
- Updated the Run Map prefab builder code so future generated prefabs add and wire `RunMapNodeRepresentation`.
- Added a Unity Editor generator for `PRD_19_021_RunMap_RouteNode_Polished.prefab`.
...
- The polished route-node prefab is generated by the Unity Editor builder because the new component needs Unity import metadata before prefab YAML can safely reference it.
